                ...
                if (apexdemo2.length > 0) {
                  var options = {
                    ...
                    series: [{
                        ...
                        name: 'Revenue',
                        data: [20, 30, 40, 55, 45, 65, 80, 95, 130]
                    }, {
                        name: 'Profit',
                        data: [10, 15, 25, 40, 30, 45, 60, 85, 100]
                    }],
                    xaxis: {
               ...
               var chart = new ApexCharts(
                ...
                if (apexdemo3.length > 0) {
                  var options = {
                    ...
                    series: [{
                      name: 'Revenue',
                      data: [45541]  // Data for total revenue
                  }, {
                      name: 'Cost',
                      data: [6456]  // Data for total cost
                  }, {
                      name: 'Deals Added',
                      data: [86]  // Data for deals added
                  }, {
                      name: 'Projects Closed',
                      data: [78]  // Data for projects closed
                  }],
                    colors: ['#8E54E9', '#2bcbba'],
                    xaxis: {
                        categories: ['Total Revenue', 'Total Cost', 'Deals Added', 'Projects Closed'],               
                    },
                    tooltip: {
                        x: {
                             format: 'dd/MM/yy'
