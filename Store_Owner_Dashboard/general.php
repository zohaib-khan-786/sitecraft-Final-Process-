    ...
    if (isset($_GET['store_id'])) {
        ...
        if ($stmt->execute()) {
            ...
            if ($result->num_rows > 0) {
                ...
                echo "No store found with the given ID.";
                exit();
            }
                ...
                <main>
                     ...
                     <div class="sidebar d-flex flex-column justify-content-between">
                        ...
                        <a href="index.php?store_id=<?php echo $store_id?>"><li class="nav-item first "><i class="bi bi-pie-chart"></i><span class="nav-text">Dashboard</span></li></a>
                            <li class="nav-item sub-menu-parent active position-relative"><i class="bi bi-rocket-takeoff"></i><span class="nav-text">Setup <i class="bi bi-chevron-down position-absolute end-0 me-3 fw-bold"></i></span>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="site_name" value="<?php echo $data['name']?>" class="form-control" id="siteName" placeholder="Enter your site name">
                            </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                        ...
                                        <img id="filePreview" class="rounded mx-auto" src="<?php echo $data['logo']?>" alt="File Preview">
                            </div>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="siteDomain" class="form-label">Domain Name</label>
                                <input type="text" value="<?php echo $data['domain']?>" class="form-control" id="siteDomain" placeholder="Enter your domain">
                            </div>
            ...
            <div class="col-md-12">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="additionalSetting" class="form-label">Theme</label>
                                <button class="btn btn-success mx-auto d-block" type="button"><a href="../Create_Store/dashboard.php?id=<?php echo $data['id']?>" class="text-light">Click To Change Theme</a></button>
                            </div>
