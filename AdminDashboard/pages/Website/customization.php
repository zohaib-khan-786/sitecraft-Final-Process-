                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="website-builder-management">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="./customization.php">Customization Options</a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- <li class="nav-item">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Theme Colors</td>
                                                    <td>Select and customize theme colors to match your brand.</td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>Fonts</td>
                                                    <td>Choose from a wide variety of fonts to enhance readability and style.</td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td>Layouts</td>
                                                    <td>Pick from different layout options to arrange content effectively.</td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    <td>Custom CSS</td>
                                                    <td>Apply custom CSS to further personalize your website.</td>
                                                </tr>
                                                <tr>
                                                    <td>5</td>
                                                    <td>Drag and Drop</td>
                                                    <td>Easily drag and drop elements to design your website layout without any coding.</td>
                                                </tr>
                                                <tr>
                                                    <td>6</td>
                                                    <td>Select Product Images</td>
                                                    <td>Choose and customize product images to enhance your store’s appearance.</td>
                                                </tr>
                                                <tr>
                                                    <td>7</td>
                                                    <td>Change Store</td>
                                                    <td>Switch between different store templates or themes with ease.</td>
                                                </tr>
                                                <tr>
                                                    <td>8</td>
                                                    <td>Create Store</td>
                                                    <td>Start a new store with a variety of customization options available.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
