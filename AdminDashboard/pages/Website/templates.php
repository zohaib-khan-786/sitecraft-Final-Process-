                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>Yamifood</td>
                                                    <td>A stylish and modern template designed specifically for food and restaurant websites.</td>
                                                </tr>
                                                <tr>
                                                    <td>2</td>
                                                    <td>Giftos</td>
                                                    <td>An elegant template ideal for gift shops and online gift stores.</td>
                                                </tr>
                                                <tr>
                                                    <td>3</td>
                                                    <td>Freshshop</td>
                                                    <td>A fresh and vibrant template perfect for grocery stores and organic shops.</td>
                                                </tr>
                                                <tr>
                                                    <td>4</td>
                                                    <td>Vegefoods</td>
                                                    <td>A template focused on healthy and organic food products, suitable for farm and food businesses.</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
