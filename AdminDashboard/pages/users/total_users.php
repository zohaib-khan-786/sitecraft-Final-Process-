...
$query = "select id, username, email, created_at, Status FROM users";
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="user-management">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="./active-inactive.php">Active Users and <br> Inactive Users</a></li>
                                <!-- <li class="nav-item"><a class="nav-link" href="./users/active-inactive.php">Inactive Users</a></li> -->
                                <li class="nav-item"><a class="nav-link" href="./total_users.php">Total User</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="store-management">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <!-- <li class="nav-item"><a class="nav-link" href="../stores/pending-published.php">Pending and <br>Published Stores</a></li> -->
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="website-builder-management">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"><a class="nav-link" href="/admin/websites/templates">Templates</a></li>
                                <li class="nav-item"><a class="nav-link" href="/admin/websites/customization">Customization Options</a></li>
                            </ul>
                        </div>
                    </li>
                    <!-- <li class="nav-item">
                                            ...
                                            <tbody>
                                                <?php while ($user = $result->fetch_assoc()): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $user['Status'] === 'verified' ? '<span class="badge badge-success">Verified</span>' : '<span class="badge badge-danger">Non-Verified</span>'; ?>
                                                        </td>
