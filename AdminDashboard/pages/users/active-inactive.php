...
// Fetch Active Users
$query_active = "select id, username, email, created_at from users WHERE Status_Update = 'active'";
$result_active = $conn->query($query_active);
$active_users = $result_active->fetch_all(MYSQLI_ASSOC);

// Fetch Inactive Users
$query_inactive = "select id, username, email, created_at from users where Status_Update = 'inactive'";
$result_inactive = $conn->query($query_inactive);
