                ...
                <div class="row">
                    <div class="col-md-4 offset-md-4 form">
                        <form action="new-password.php" method="POST" autocomplete="off">
                            <h2 class="text-center" style="font-weight: bold;  margin-bottom:1rem;">New Password</h2>
                            <?php 
                            ...
                            <div class="form-group">
                                <input class="form-control button btn-primary mt-5" type="submit" name="change-password" value="Change">
                            </div>
                        </form>
                    </div>
                </div>
