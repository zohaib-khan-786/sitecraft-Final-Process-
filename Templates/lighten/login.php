         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2">
                  <li class="active"><a class="buy" href="./login.php">Login</a></li>
               </div>
            </div>
         </div>
         <!-- end header inner --> 
    ...
    <div class="container mt-5">
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <p class="mt-3 text-center para2">Don't hane an account? <a class="reg" href="./signup.php">Register here</a></p>
            </div>
        </div>
    </div>
