...
<body class="main-layout">
      ...
      <div class="container">
         <div class="white_bg">
            <div class="row">
               ...
               <div class="col-md-12">
                  <a class="read-more" href="./blog.php">Read More</a>
               </div>
            </div>
         </div>
       </div>
   ...
   <?php
      ...
      $query = "SELECT * FROM products where id >= 40 and id <=47";
      ...
      <div class="product-bg-white">
         <div class="container">
            <div class="row">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="./images/layout2.png"/ style="background-color: white; height:13rem;"></i>
                     <h3>Smart Speaker (Echo Dot) </h3>
                     <span>$40.00</span>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="./images/layout3.png"/ style="background-color: white; height:13rem;"></i>
                     <h3>Headphones</h3>
                     <span>$35.00</span>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="icon/p8.png"/ style="background-color: white;"></i>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="icon/p9.png"/ style="background-color: white; height:13rem;"></i>
                     <h3>Camera</h3>
                     <span>$100.00</span>
                  </div>
               </div> -->
