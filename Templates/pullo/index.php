						...
						<div id="myCarousel" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-item">
								<div class="row">
									...
									<div class="col-sm-5">
										<div class="banner_taital">
											<h1 class="banner_text">Casual Sneakers</h1>
											<h1 class="mens_text"><strong>Men's Like Plex</strong></h1>
											<p class="lorem_text">ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
											<button class="buy_bt">Buy Now</button>
									...
									<div class="col-sm-5">
										<div class="shoes_img"><img src="./images/Sneakers.png"></div>
									</div>
								</div>
                			</div>
                			<div class="carousel-item">
                    			<div class="row">
									...
									<div class="col-sm-5">
										<div class="banner_taital">
											<h1 class="banner_text">Formal Leather Shoes</h1>
											<h1 class="mens_text"><strong>Men's Like Plex</strong></h1>
											<p class="lorem_text">ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
											<button class="buy_bt">Buy Now</button>
											<a href="#"><button class="more_bt">See More</button></a>
										</div>
									</div>
									<div class="col-sm-5">
										<div class="shoes_img"><img src="images/Leather-shoes.png"></div>
									</div>
								</div>
                			</div>
							<div class="carousel-item">
								<div class="row">
									...
									<div class="col-sm-5">
										<div class="banner_taital">
											...
											<p class="lorem_text">ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
											<button class="buy_bt">Buy Now</button>
											<a href="./racing boots.php"><button class="more_bt">See More</button></a>
										</div>
									</div>
									<div class="col-sm-5">
										<div class="shoes_img"><img src="images/F-Running-Shoes.png"></div>
									</div>
								</div>
							</div>
						</div>
    ...
    <div class="layout_padding gallery_section">
    	<div class="container">
    		<div class="row">
    			...
    			<!-- <div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Boots</p>
    					<div class="shoes_icon"><img src="images/Boots.png" style="height: 12rem;"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Casual Sport Shoes</p>
    					<div class="shoes_icon"><img src="images/Casual-Sport-Shoes.png" style="height: 12rem;"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
    		...
    		<!-- <div class="row">
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Running Shoes</p>
    					<div class="shoes_icon"><img src="images/F-Running-Shoes.png" style="height: 12rem;"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Sneakers</p>
    					<div class="shoes_icon"><img src="images/Sneakers.png" style="height: 12rem;"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
    			...
    			<div class="col-sm-4">
    				<div class="best_shoes">
    					<p class="best_text">Combat Boots</p>
    					<div class="shoes_icon"><img src="images/Combat-Boots.png" style="height: 12rem;"></div>
    					<div class="star_text">
    						<div class="left_part">
    							<ul>
    	    						<li><a href="#"><img src="images/star-icon.png"></a></li>
