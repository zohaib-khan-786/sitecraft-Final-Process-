  ...
  <div class="hero-area"></div>
          ...
          <div class="collapse navbar-collapse px-5" id="navbarSupportedContent">
              <ul class="navbar-nav me-auto">
                  <li class="nav-item active">
                      <a class="nav-link" aria-current="page" href="index.php">Home <span class="visually-hidden">(current)</span></a>
                  </li>
                  <div class="btn-group">
                    <a class="btn" href="shop.php" role="button" id="dropdownMenuLink">
                      Shop
                    </a>
    ...
    <section class="shop_section layout_padding">
      <div class="container">
        ...
        <div class="row productList" id="products">
          <!-- Product Cards -->
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="box">
              ...
              <!-- <button class="btn btn-primary add-to-cart" data-id="1" data-name="Ring" data-price="200" data-image="images/p1.png">
                Add to Cart
              </button> -->
              ...
              <!-- <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="2" data-name="Watch" data-price="300" data-image="images/p2.png">
                        Add to Cart
                      </button> -->
                ...
                <input type="hidden" name="product_image" value="images/p2.png">
                <input type="hidden" name="template_name" value="Giftos">
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="3" data-name="Teddy Bear" data-price="110" data-image="images/p3.png">
                        Add to Cart
                      </button> -->
                      <!-- <form method="POST" action="cart.php">
                <input type="hidden" name="product_id" value="3">
                <input type="hidden" name="product_name" value="Teddy Bear">
                <input type="hidden" name="product_price" value="110">
                <input type="hidden" name="product_image" value="images/p3.png">
                <input type="hidden" name="template_name" value="Giftos">
                <button type="submit" name="add_to_cart" class="btn btn-primary add-to-cart">Add to Cart</button>
              </form>
                  </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="4" data-name="Flower Bouquet" data-price="45" data-image="images/p4.png">
                        Add to Cart
                      </button> -->
                      <!-- <form method="POST" action="cart.php">
                <input type="hidden" name="product_id" value="4">
                <input type="hidden" name="product_name" value="Flower Bouquet">
                <input type="hidden" name="product_price" value="45">
                <input type="hidden" name="product_image" value="images/p4.png">
                <input type="hidden" name="template_name" value="Giftos">
                <button type="submit" name="add_to_cart" class="btn btn-primary add-to-cart">Add to Cart</button>
              </form>
                  </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="5" data-name="Teddy Bear" data-price="95" data-image="images/p5.png">
                        Add to Cart
                      </button> -->
                      <!-- <form method="POST" action="cart.php">
                ...
                <input type="hidden" name="product_image" value="images/p5.png">
                <input type="hidden" name="template_name" value="Giftos">
                <button type="submit" name="add_to_cart" class="btn btn-primary add-to-cart">Add to Cart</button>
              </form>
                  </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="6" data-name="Flower Bouquet" data-price="70" data-image="images/p6.png">
                        Add to Cart
                      </button>
                  </div> -->
                  <!-- <form method="POST" action="cart.php">
                ...
                <input type="hidden" name="product_image" value="images/p6.png">
                <input type="hidden" name="template_name" value="Giftos">
                <button type="submit" name="add_to_cart" class="btn btn-primary add-to-cart">Add to Cart</button>
              </form>
              </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="7" data-name="Watch" data-price="400" data-image="images/p7.png">
                        Add to Cart
                      </button> -->
                      <!-- <form method="POST" action="cart.php">
                ...
                <input type="hidden" name="product_image" value="images/p7.png">
                <input type="hidden" name="template_name" value="Giftos">
                <button type="submit" name="add_to_cart" class="btn btn-primary add-to-cart">Add to Cart</button>
              </form>
                  </div>
              ...
              <div class="col-sm-6 col-md-4 col-lg-3">
                  <div class="box">
                      ...
                      <!-- <button class="btn btn-primary add-to-cart" data-id="8" data-name="Ring" data-price="450" data-image="images/p8.png">
                        Add to Cart
                </button> -->
                <!-- <form method="POST" action="cart.php">
                ...
                <input type="hidden" name="product_image" value="images/p8.png">
                <input type="hidden" name="template_name" value="Giftos">
                <button type="submit" name="add_to_cart" class="btn btn-primary add-to-cart">Add to Cart</button>
              </form>
            </div>
  ...
  <script>
    function addToCart(id, name, price, image) {
        ...
        if (existingProduct) {
            ...
            cart.push(product);  // Add new product if not in the cart
        }
