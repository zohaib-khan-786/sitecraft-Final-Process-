...
<body>
    ...
    <div class="about-box-main">
        <div class="container">
            <div class="row">
				<div class="col-lg-6">
                    <div class="banner-frame"> <img class="img-fluid" src="images/about-us.jpeg" alt="" />
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row my-4">
                    ...
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-1.jpg" alt="" />
                            <div class="team-content">
                                <h3 class="title">James Davis</h3> <span class="post">Supply Chain Anaylst</span> </div>
                            <ul class="social">
                                <li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-2.jpeg" alt="" />
                            <div class="team-content">
                                <h3 class="title">Emily Johnson</h3> <span class="post">Marketing Specialist</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="fab fa-facebook"></a>
                                </li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-3.jpg" alt="" / style="height: 24rem;">
                            <div class="team-content">
                                <h3 class="title">Michael Brown</h3> <span class="post">Web Developer</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="fab fa-facebook"></a>
                                </li>
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="hover-team">
                        <div class="our-team"> <img src="images/img-4.jpeg" alt="" / >
                            <div class="team-content">
                                <h3 class="title">Sarah Williams</h3> <span class="post">Product Manager</span> </div>
                            <ul class="social">
                                <li>
                                    <a href="#" class="fab fa-facebook"></a>
                                </li>
