...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    // Retrieve post data
    $paymentMethod = 'cod'; // Payment method is 'cod'
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        <form action="checkout.php" method="POST" class="needs-validation" novalidate>
                            ...
                            <hr class="mb-4">
                            <button class="ml-auto btn btn-lg btn-block hvr-hover" type="submit">Place Order</button>
                        </form>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6 mb-3">
                                        ...
                                        <div class="media mb-2 border-bottom">
                                            ...
                                            <a href="#"><?php echo htmlspecialchars($item['product_name']); ?></a>
                                                <div class="small text-muted">
                                                    Price: $<?php echo htmlspecialchars($item['product_price']); ?>
                                                    <span class="mx-2">|</span> 
                                                    Qty: <?php echo htmlspecialchars($item['quantity']); ?>
                                                    <span class="mx-2">|</span> 
                                                    Subtotal: $<?php echo htmlspecialchars($item['product_price'] * $item['quantity']); ?>
                                                </div>
                                            </div>
                                        </div>
                                    <?php } ?>
                        ...
                        <div class="col-md-12 col-lg-12 mt-3">
                            ...
                            <div class="rounded p-2 bg-light">
                                <div class="media mb-2 border-bottom">
                                    <div class="media-body">
                                        <div class="small text-muted">
                                            Sub Total: $<?php echo htmlspecialchars($totalAmount); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="media mb-2 border-bottom">
                                    <div class="media-body">
                                        <div class="small text-muted">
                                            Shipping Fee: $10.00  Example shipping fee
                                        </div>
                                    </div>
                                </div> 
                                 <div class="media mb-2 border-bottom">
                                    <div class="media-body">
                                        <div class="small text-muted">
                                          Grand Total: $<?php echo htmlspecialchars($totalAmount + 10.00); ?>  Total + shipping fee  
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-sm-6 col-lg-6 mb-3">
                    <div class="checkout-address">
                        ...
                        <form action="checkout.php" method="POST" class="needs-validation" novalidate>
                            ...
                            <hr class="mb-4">
                            <div class="title"> <span>Payment</span>
                            </div>
                            <div class="d-block my-3">
                                <div class="custom-control custom-radio">
                                    <input id="credit" name="paymentMethod" type="radio" class="custom-control-input" checked required>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-12">
                            <div class="shipping-method-box">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="ml-4 mb-2 small">(3-7 business days)  
                                    </div>
                                    <div class="custom-control custom-radio">
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="odr-box">
                                ...
                                <div class="rounded p-2 bg-light shopping-cart"> -->
                                    <!-- <div class="media mb-2 border-bottom">
                        ...
                        <div class="col-md-12 col-lg-12">
                            ...
                            <div class="col-12 d-flex shopping-box">
                                <button type="button" class="ml-auto btn hvr-hover" id="placeOrderButton">Place Order</button>
                            </div>
                        </div>
                    </div>
                </div>
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    <!-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        const cartItems = JSON.parse(localStorage.getItem('freshshopCart')) || [];
        const cartContainer = document.querySelector('.shopping-cart');
        const orderSummaryContainer = document.querySelector('.order-box');
        ...
        cartItems.forEach(item => {
            ...
            cartItemElement.className = 'media mb-2 border-bottom';
            cartItemElement.innerHTML = `
                <div class="media-body">
                    <a href="#">${item.name}</a>
                    <div class="small text-muted">Price: $${item.price.toFixed(2)} <span class="mx-2">|</span> Qty: ${item.quantity} <span class="mx-2">|</span> Subtotal: $${itemTotal.toFixed(2)}</div>
                </div>
            `;
        ...
        const orderSummaryHTML = `
            <div class="d-flex">
                <h4>Sub Total</h4>
                <div class="ml-auto font-weight-bold"> $${subTotal.toFixed(2)} </div>
            </div>
            <div class="d-flex">
                <h4>Discount</h4>
            ...
            <div class="d-flex gr-total">
                <h5>Grand Total</h5>
                <div class="ml-auto h5"> $${subTotal.toFixed(2)} </div>
            </div>
            <hr>
        `;

        orderSummaryContainer.insertAdjacentHTML('beforeend', orderSummaryHTML);
    });

    document.getElementById('placeOrderButton').addEventListener('click', function() {
        alert('Order placed successfully!');
        // Here, you can handle order submission (e.g., send data to the server)
    });
</script> -->
